    ...
    initializePersonalities() {
        this.personalities = {
            'FPMR': {
                ...
                description: '你是思想的源头，痴迷于用最优雅的公理构建整个世界的解释体系。你追求的是"思想灯塔"，渴望提出一个能流传数十年的理论范式。',
            ...
            'FEDR': {
                ...
                description: '你是数据中的哥伦布，坚信新大陆就藏在海量数据中。你痴迷于发明全新的数据分析和可视化方法，从看似混乱的数据中发现颠覆性的、全新的科学规律。',
            ...
            'AEMI': {
                ...
                description: '你是应用效果的"魔法师"，对现有模型和系统的每一个角落都了如指掌。你通过精妙的实验设计和大量的tricks，将模型的性能调至毫厘之间的极限。',
